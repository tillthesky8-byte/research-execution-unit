...
public record MarketContext
{
    ...
    public OhlcvBar this[string symbol] => PriceData.TryGetValue(symbol, out var ohlcv) ? ohlcv : throw new KeyNotFoundException($"Price data for symbol '{symbol}' not found in market context.");
